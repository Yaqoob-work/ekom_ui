import 'package:ekom_ui/widgets/utils/color_service.dart';
  ...
  void _handleFocusChange(bool hasFocus) async {
    ...
    if (hasFocus) {
      if (widget.item.id == 'view_all') {
        ...
        dominantColor = Colors.blue.withOpacity(0.8);
      } else {
        // For content items, extract color from the banner
        dominantColor = await ColorUtils.getPaletteColor(widget.item.banner);
      }
      setState(() {});
    }
  }
